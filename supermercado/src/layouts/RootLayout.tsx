  ...
  return (
    ...
    >
      <AppShell.Header>
        <Group h="100%" px="md" justify="space-between">
          <Group>
            ...
            <Group gap="xs" style={{ cursor: 'pointer' }} onClick={() => navigate('/app')}>
              <IconBuildingStore size={26} color="var(--mantine-color-blue-6)" />
      ...
      <AppShell.Navbar p="md">
        <Stack gap="xs">
          <RouterNavLink to="/app" end style={{ textDecoration: 'none' }} onClick={close}>
            {({ isActive }) => (
              <MantineNavLink
                label="Dashboard"
          ...
          <RouterNavLink to="/app/produtos" style={{ textDecoration: 'none' }} onClick={close}>
            {({ isActive }) => (
              <MantineNavLink
                label="Produtos"
